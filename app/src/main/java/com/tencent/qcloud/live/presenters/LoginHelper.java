package com.tencent.qcloud.live.presenters;
...
import com.tencent.qcloud.live.presenters.viewinface.LoginView;
import com.tencent.qcloud.live.presenters.viewinface.LogoutView;
...
//                        Toast.makeText(mContext, "IMLogin succ !", Toast.LENGTH_SHORT).show();
    ...
    public void tlsLogin(final String id, final String password) {
        new Thread(){
            ...
            public void run() {
                super.run();
                final ArrayList<String> strings = OKhttpHelper.getInstance().loginLogic(id, password);
                final String sign = strings.get(0);
                MySelfInfo.getInstance().setId(id);
                MySelfInfo.getInstance().setUserSig(sign);
                imLogin(id, sign);
            }
        }.start();
...
//                SxbLog.i(TAG, "TLS OnPwdLoginSuccess " + tlsUserInfo.identifier);
                ...
                //String userSig = "eJxljlFPgzAUhd-5FYRXjbawWvQN5*YWVxRhNvhCKu3GzTJgrAjD*N83cYkkntfvu-ecL8M0TStahFciTYs614k*lMoy70wLWZd-sCxBJkInTiX-QdWWUKlErLSqeogJITZCQwekyjWs4Gy0IIqshoGwl5ukb-n9MDqdY0xvnaEC6x6ySTyeB*PpLmL1R*y708YXPklfN*yJPIYv4oIu3pv24NFcctaxzg7mmfeckTUj9fY69t949aCbgDP7nnJn1i1n0PClW8b1xMPhLhpUatiq86Ab6lI6ou6AfqpqD0XeCzbCBNsO*ollfBtHHodd-g__";
                String userSig = "eJxlj11PgzAUhu-5FYRrYwqlK5h4AftAyHSgbAZvmmYtTdkExuoYGv*7ikts4rl9nve853wYpmla*fLpmm63zVutiBpabpk3pgWsqz-YtpIRqgjs2D-Iz63sOKGl4t0IbYSQA4DuSMZrJUt5MXpai0pSTTiyHRlbfje433Hbxj7UFSlGeD9fT*Ns6t0l6blLRNYHzmp4jx*wF8BwXkWnUjjDblKUq7A9zLxSBLFYZMXmhT36cJ*GsxAfYJQv-Oy5iJJ9vnGXAPYpTpqqgPX6VqtU8pVfDppgD2MX6U*deHeUTT0KDrCR7UDwM5bxaXwBlClcrQ__";
    ...
    private void getMyRoomNum() {
        if (MySelfInfo.getInstance().getMyRoomNum() == -1) {
            new Thread(new Runnable() {
                @Override
                public void run() {
                    final OKhttpHelper instance = OKhttpHelper.getInstance();
                    instance.getMyRoomId(mContext);
                }
            }).start();
        }
    }
