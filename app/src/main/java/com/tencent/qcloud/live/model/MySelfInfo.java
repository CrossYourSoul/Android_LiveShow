...
public class MySelfInfo {
    ...
    private String userSig; // 签名 -服务器返回
    private String nickName;    // 呢称
    private String avatar;      // 头像
    private String sign;      // 签名
    private String CosSig; // 封面储存空间签名 - 上传封面的时候会用到
    ...
    public void getCache(Context context) {
        SharedPreferences sharedata = context.getSharedPreferences(Constants.USER_INFO, 0);//SpName : user_info
