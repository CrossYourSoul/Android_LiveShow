package com.tencent.qcloud.live.adapters;
...
public class LiveShowAdapter extends ArrayAdapter<LiveInfoJson> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (!TextUtils.isEmpty(data.getCover())){
            ...
            // http://web-res.oss-cn-beijing.aliyuncs.com/home/images/function3.png
            // holder.ivCover.setImageResource(R.drawable.cover_background);
            Glide.with(mActivity).load("http://web-res.oss-cn-beijing.aliyuncs.com/home/images/function3.png").into(holder.ivCover);
        }
